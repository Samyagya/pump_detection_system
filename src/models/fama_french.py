...
results.to_csv(
    os.path.join("data", "results", "ANMOL_ff3_results.csv"),
    index=False
)
...
df.to_csv(
    os.path.join("data", "results", "ANMOL_abnormal_returns.csv")
)
...
print("\nFiles Saved:")
print("data/results/ANMOL_ff3_results.csv")
print("data/results/ANMOL_abnormal_returns.csv")