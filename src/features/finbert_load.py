...
df = pd.read_csv(os.path.join("data", "news", "eurotex_master_news.csv"))
...
df.to_csv(
    os.path.join("data", "sentiment", "eurotex_article_sentiment.csv"),
    index=False
)
...
daily.to_csv(
    os.path.join("data", "sentiment", "eurotex_daily_sentiment.csv"),
    index=False
)
